...
urlpatterns = [
    ...
    path('<int:acc_id>/chat/<int:user_id>/', views.chatPage, name='chatPage'),
    path('<int:acc_id>/chat/<int:user_id>/save', views.save_message, name='saveMessage'),
    path('<int:acc_id>/chat/<int:user_id>/get', views.get_message, name='getMessage'),
]