...
urlpatterns = [
    ...
    path('bills/viewBill/<int:billId>/accept/<int:billId2>', views.accept, name='accept'),
    path('bills/viewBill/<int:billId>/decline/<int:billId2>', views.decline, name='decline'),
